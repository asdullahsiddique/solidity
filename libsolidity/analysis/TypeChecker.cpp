...
bool typeSupportedByOldABIEncoder(Type const& _type)
{
	...
	else if (_type.category() == Type::Category::Array)
	{
		...
		if (!arrayType.isDynamicallyEncoded())
			return typeSupportedByOldABIEncoder(*base);
		else if (base->category() == Type::Category::Struct)
			return false;
		else if (base->category() == Type::Category::Array)
			return false;
		else
			return true;
	}
